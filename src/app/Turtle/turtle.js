...
const _main = () => {
   ...
   */
   ...
   // expose API globally
   [
  'forward','right','left','goto','clear','penup','pendown','reset',
  'angle','degToRad','radToDeg','width','shape','colour','color',
  'write','random','hideTurtle','showTurtle','redrawOnMove',
  'draw','repeat','wrap','animate','range'
].forEach(fn => {
  // @ts-ignore
